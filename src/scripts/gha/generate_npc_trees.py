...
root_folder = 'data/npcs/text'
repo_url = 'https://github.com/s2ward/tibia/blob/main/data/npcs/text'
...
def build_tree_from_mapping(mapping, base_url, only_empty=False, only_unverified=False, only_verified=False, only_unverified_empty=False):
            ...
            if isinstance(value, dict):
                ...
                if only_empty and value != "EMPTY":
                    ...
                    continue
                        ...
                        continue
                elif only_unverified_empty and value not in ["UNVERIFIED", "EMPTY"]:
                        continue
...
def add_navigation(filename, current_tree_index):
    navigation = [
        ...
        f'5. Unverified or Empty Transcripts: [↗](./unverified_empty_transcripts.md)',
    ]
...
unverified_empty_files_tree = build_tree_from_mapping(file_mapping, repo_url, only_unverified_empty=True)

# Draw trees and save them to files
draw_tree([all_files_tree], 'docs/npc_trees/all_transcripts.md')
draw_tree([verified_files_tree], 'docs/npc_trees/verified_transcripts.md')
draw_tree([empty_files_tree], 'docs/npc_trees/empty_transcripts.md')
draw_tree([unverified_files_tree], 'docs/npc_trees/unverified_transcripts.md')
draw_tree([unverified_empty_files_tree], 'docs/npc_trees/unverified_empty_transcripts.md')

# Post-process files
post_process_file('docs/npc_trees/all_transcripts.md')
post_process_file('docs/npc_trees/verified_transcripts.md')
post_process_file('docs/npc_trees/empty_transcripts.md')
post_process_file('docs/npc_trees/unverified_transcripts.md')
post_process_file('docs/npc_trees/unverified_empty_transcripts.md')

# Add navigation
add_navigation('docs/npc_trees/all_transcripts.md', 0)
add_navigation('docs/npc_trees/verified_transcripts.md', 1)
add_navigation('docs/npc_trees/empty_transcripts.md', 2)
add_navigation('docs/npc_trees/unverified_transcripts.md', 3)
add_navigation('docs/npc_trees/unverified_empty_transcripts.md', 4)
